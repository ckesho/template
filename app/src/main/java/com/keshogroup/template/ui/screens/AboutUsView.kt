...
@Composable
fun aboutUs(name: String, modifier: Modifier = Modifier, onConfirmClick:(destination:String)-> Unit, onCancelClick:(destination:String)->Unit, ) {
    Column(modifier){
        Text(
            text = "AboutUs",
            modifier = modifier
...
fun aboutUsPreview() {
    TemplateTheme {
        settingsViewF("AboutUs", onConfirmClick = { }, onCancelClick= {})
    }
}